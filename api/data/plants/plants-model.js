...
async function findPlantsForUser(user_id) {
  ...
  function addPlant(user_id, plant){
    ...
    .then(()=>{
        ...
        .select('plants_id','plants.nickname','plants.species','plants.image','users.username', 'plants.waterFrequency')
...
async function removePlant(plants_id){
  ...
  module.exports = {  findPlantsForUser, findBy, addPlant, updatePlant, removePlant, findAllPlants };